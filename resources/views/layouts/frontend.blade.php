        ...
        <div class="container-fluid footer py-5 wow fadeIn" data-wow-delay="0.2s">
            <div class="container py-5">
                <div class="row g-5">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-3">
                                    <div class="footer-item">
                                        ...
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Banner</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Recently Events</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Coming Soon Events</a>
                                        ...
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">Jl. Jalur Sutera Bar. No.Kav. 21, RT.001/RW.004, Panunggangan, Kec. Pinang, Kota Tangerang, Banten 15143
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">ticoz@lapaktiket.com</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">(+62) 821-2245-7443</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-3">
                        <div class="footer-item">
                            <h4 class="text-white mb-4">Notification</h4>
                            ...
                            <div class="d-flex flex-shrink-0">
                                <div class="footer-btn">
                                    <a href="https://wa.me/6282122457443" class="btn btn-lg-square rounded-circle position-relative wow tada" data-wow-delay=".9s">
                                        <i class="fa fa-phone-alt fa-2x"></i>
                                ...
                                <div class="d-flex flex-column ms-3 flex-shrink-0">
                                    ...
                                    <a href="https://wa.me/6282122457443"><span class="text-white">Contact Via WhatsApp</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid copyright py-4">
            <div class="container" style="justify-content: center;">
                <div class="row g-4 align-items-center">
                        ...
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Ticoz 2024</a></span>
